            ...
            *what = 0;
            ...
            for (q = replacement[i]; q && *q; ++q) {
              if (*q != '@') {
                ...
                if (at_start_of_input_line) {
                  if (!strncmp(q, "@end ignore", 11) ||
                      !strncmp(q, "@end menu", 9) ||
                      !strncmp(q, "@end iftex", 10) ||
                      !strncmp(q, "@end tex", 8) ||
                    ...
                    ++line_no;
                    continue;
                  } else if (!strncmp(q, "@end example", 12) ||
                             !strncmp(q, "@end smallexample", 17)) {
                    if (!at_start_of_line) {
                      putchar('\n');
                    }
                    ...
                    ++line_no;
                    continue;
                  } else if (!strncmp(q, "@section ", 9) ||
                             !strncmp(q, "@appendix ", 10) ||
                             !strncmp(q, "@subsection ", 12) ||
                             !strncmp(q, "@subheading ", 12)) {
                    if (!at_start_of_line) {
                      putchar('\n');
                    }
                ...
                if (!strncmp(q, "@code{", 6) || !strncmp(q, "@env{", 5) ||
                    !strncmp(q, "@command{", 9)) {
                  if (!in_section) {
                    start_bold();
                  }
